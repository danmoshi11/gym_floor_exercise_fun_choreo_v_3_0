...
const SupabaseEngine = {
    ...
    init: function() {
        ...
        const SUPABASE_URL = 'https://aorjdomtvnlmwjhhetes.supabase.co';
        // 🚨 开发者注意：此处的 KEY 必须是 Supabase 颁发的以 eyJhbG... 开头的超长 JWT 字符串！
        const SUPABASE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImFvcmpkb210dm5sbXdqaGhldGVzIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODA0ODI4NjQsImV4cCI6MjA5NjA1ODg2NH0.Ism_ygrwbspclpQdz9x9cLKL2rY5WCXRQg-v3SaRA_k';
